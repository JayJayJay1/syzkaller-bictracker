...
func (linux linux) build(params Params) (ImageDetails, error) {
	...
	// fmt.Printf("§4.5 Building linux kernel\n")
	...
	if fileInfo, err := os.Stat(params.UserspaceDir); err == nil && fileInfo.IsDir() {
		...
		// fmt.Printf("§5bCopying files for quemu\n")
...
func (linux linux) buildKernel(params Params) error {
	...
	// fmt.Printf("§1.5 Running make oldconfig \n")
...
func (linux) createImage(params Params, kernelPath string) error {
	...
	// fmt.Printf("§t Starting command: \"%v\" userpace \"%v\" kernelpath \"%v\" targetarch \"%v\"", scriptFile, params.UserspaceDir, kernelPath, params.TargetArch)
